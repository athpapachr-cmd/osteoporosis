"""Actual Chromium acceptance for Step 6A smart qualifiers."""
...
class QualifierBrowserTests(unittest.TestCase):
    ...
    def test_quadriceps_atrophy_refines_summary_and_referral(self):
        ...
        self.page.locator('[data-q-weakness=quadriceps]').click()
        ...
        expect(self.page.locator('[data-smart-root=weakness] [data-smart-summary]')).to_contain_text('Τετρακέφαλος')
    ...
    def test_fixed_flexion_is_advanced_exam_not_stiffness(self):
        ...
        expect(self.page.locator('#referralText')).to_contain_text('fixed flexion deformity')
        expect(self.page.locator('#referralText')).to_contain_text('10°')

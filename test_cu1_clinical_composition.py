...
class CU1ClinicalCompositionTests(unittest.TestCase):
    ...
    def test_realistic_frozen_case_has_exact_natural_short_and_detailed_output(self):
        ...
        expected_detailed = (
            ...
            "εύρος κίνησης και στη λειτουργική βελτίωση. Η επιλογή και δοσολογία των επιμέρους ασκήσεων και τεχνικών "
            "εξατομικεύονται από τον φυσιοθεραπευτή σύμφωνα με την κλινική ανταπόκριση.\n\n"
            "ΕΠΑΝΕΚΤΙΜΗΣΗ\n"
            "Ιατρική επανεκτίμηση εφόσον η πορεία δεν είναι η αναμενόμενη, προκύψουν νέα κλινικά ή τραυματικά στοιχεία "
            "ή απαιτείται αναθεώρηση της στρατηγικής αντιμετώπισης.\n"
        )
